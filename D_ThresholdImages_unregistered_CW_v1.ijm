...
// Works for unregistered images (only difference from registered is foldername and you might have to change minslice/maxslice etc)
...
source_dir = main_dir + "SplitTiffs/pERK/";
